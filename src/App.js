...
*/}
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>1.</b></td>
            <td valign="top"><p><b><i>Lazy apple</i>. What motion of the apple does this initial horizontal worldline describe? Have you ever observed an apple following such a horizontal worldline? Is a horizontal worldline possible for an apple subject to only the downward gravitational force?<br /><br /></b></p></td>
          </tr>
        </tbody></table>
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>2.</b></td>
            <td valign="top"><p><b><i>Jumpy apple</i>. From the formula for the action, explain why the value of the action begins to rise again as the point is dragged upward beyond a certain height. [Hint: How does potential energy depend on the height of the dot? How does kinetic energy depend on the velocity (the slope of each segment)?]<br /><br /></b></p></td>
          </tr>
        </tbody></table>
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>3.</b></td>
            <td valign="top"><p><b><i>Cooperating events. Predict</i>: If you go back and drag the first intermediate dot up and down, can you make the value of the action decrease still further?<br /><br /></b></p></td>
          </tr>
        </tbody></table>
      <p>Try it by dragging the first dot up and down again. What is the answer to the question? Did you predict correctly?</p>
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>4.</b></td>
            <td valign="top"><p><b><i>Practice, practice</i>. Was <i>one</i> cycle of adjusting the height of each dot to its minimum-action height sufficient to find the worldline of least action? Explain why or why not.<br /><br /></b></p></td>
          </tr>
        </tbody></table>
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="30%" align="right" valign="top"><b /></td>
            <td valign="top"><p><b><i>Technical questions, indexed A, B, C, …, typically concern details of the displays rather than basic ideas of the principle of least action.  You may want to skip technical questions the first time through and return to them on a second or third pass.<br /><br /></i></b></p></td>
          </tr>
        </tbody></table>
...
*/}
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>6.</b></td>
            <td valign="top"><p><b><i>In a valley? Predict:</i> Which of the following statements is correct? Or are both correct? neither? "After the worldline has stopped changing: (a) If I drag one dot <i>upward</i>, the value of the action <i>S</i> will <i>decrease</i>. (b) If instead I drag the same dot <i>downward</i>, the value of the action <i>S</i> will <i>decrease</i>."  Drag one dot up and then down. Was your prediction correct? Explain.<br /><br /></b></p></td>
          </tr>
        </tbody></table>

        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
        <tbody><tr>
            <td width="10%" align="right" valign="top"><b>7.</b></td>
            <td valign="top"><p><b><i>More dots better?</i> Compare the value of minimum action for the second display with the value you found for the first display. Are they different? Why or why not?<br /><br /></b></p></td>
          </tr>
        </tbody></table>
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>8.</b></td>
              <td valign="top"><p><b><i>Landing on a step. Predict:</i> With the final event set at 5 meters height, and with the same requirement that the apple arrive at the final event 3 seconds after launch, do you expect the maximum height achieved to be greater or less than the maximum height with the final event at zero height? Make a qualitative argument for your prediction. HUNT and find the maximum height. Was your prediction and qualitative argument correct? If not, what should that argument have been?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="30%" align="right" valign="top"><b>B.</b></td>
              <td valign="top"><p><b><i>Action when hop up. Technical. Predict:</i> With the final event set at a height of 5 meters in the display, do you expect the minimum action to be less (that is, <i>more</i> negative) or greater (that is, <i>less</i> negative) than for the final event at zero height? HUNT and check out your prediction. Was it correct? Explain why or why not?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="30%" align="right" valign="top"><b>C.</b></td>
              <td valign="top"><p><b><i>Initial change in action. Technical.</i> RESET and drag one intermediate event-dot upward from the horizontal line of dots. As you start to drag the dot, does the value of the action displayed in the lower left initially increase or decrease. Return to the first display (the one with only three intermediate dots), RESET, and drag one dot upward. Initially does the value of the action increase or decrease? Why the difference in the two displays? Hint: Use the expression for the action.<br /><br /></b></p></td>
            </tr>
          </tbody></table>
...
*/}
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>9.</b></td>
              <td valign="top"><p><b><i>Throwing upward from a cliff. Predict.</i> Now you are about to increase the height of the launch event at the left (with zero height for the final event) and then HUNT. Will the resulting motion have the same uniform acceleration as in the case that both launch and catch are at zero height? Does your answer depend on how high the launch event is dragged? Will your answer be different if the catch event is also raised? RESET, drag the initial event upward, then HUNT. Were your predictions correct? If not, state the correct predictions and explain why they are correct.<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="30%" align="right" valign="top"><b>D.</b></td>
              <td valign="top"><p><b><i>Three in one. Technical.</i> RESET, then HUNT until the display stops changing. Choose one intermediate point on the worldline and drag this point up and down. Why does the change of height of <i>one</i> point lead to change in <i>three</i> entries in the acceleration table?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
...
*/}
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>10.</b></td>
              <td valign="top"><p><b><i>Throwing from cliff to cliff.</i> RESET and drag both the initial event and the final event to the same height greater than zero. <i>Predict:</i> When you HUNT and the display stops changing, will the total energy be greater or less than (or the same as) it was when initial and final events were at zero height? Press the HUNT button. Was your prediction correct? State the correct prediction and explain why it is correct.<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>11.</b></td>
              <td valign="top"><p><b><i>Catching on a step.</i> RESET and drag only the final event to a height greater than zero. Predict: When you HUNT and the display stops changing, will the total energy be greater or less than (or the same as) it was when initial and final events were at zero height? HUNT and explain why your prediction was correct or incorrect.<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>12.</b></td>
              <td valign="top"><p><b><i>Predicting the peak I.</i> RESET and HUNT until the display stops changing. From the velocity along the first segment in the preceding display, calculate the expected maximum height using the conservation of energy. How does your calculated maximum value compare with the peak value read off of the worldline directly? Can you think of a qualitative reason for any discrepancy between the two values?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>13.</b></td>
              <td valign="top"><p><b><i>Predicting the peak II.</i> Using the velocity-acceleration table in the preceding display, derive an estimate of the initial vertical velocity at <i>t</i>&nbsp;=&nbsp;0. (This is not the same as the average velocity along the first segment displayed in the table.) When you use that initial value of the velocity, how does your calculated maximum height compare with the height shown in the graph?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="30%" align="right" valign="top"><b>E.</b></td>
              <td valign="top"><p><b><i>Influence of one. Technical.</i> How many entries in the energy column <i>E</i>&nbsp;=&nbsp;<i>T</i>&nbsp;+&nbsp;<i>V</i> are altered by dragging one intermediate point away from the minimum-action condition? Explain why this is the same as or different from the number of entries changed in the acceleration table when you moved one intermediate point (technical question D).<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>14.</b></td>
              <td valign="top"><p><b><i>Lagrangian a constant?</i> HUNT until the display stops changing and look in the table for values of the Lagrangian <i>L = T&nbsp;–&nbsp;V</i>. Is the value of the Lagrangian <i>L</i> a constant of the motion?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>15.</b></td>
              <td valign="top"><p><b><i>Fickle Lagrangian.</i> Explain qualitatively why <i>L</i> has a large positive value for segments near the beginning and end of the worldline and a large negative value for segments near the maximum height.<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>16.</b></td>
              <td valign="top"><p><b><i>All-negative Lagrangian? Predict.</i> Suppose that you raise the initial and final points to the same height greater than zero. Can you find a value for this initial/final height so that all entries in the <i>L = T&nbsp;–&nbsp;V</i> column of the table are negative? Try this and report on the correctness of your prediction. Does your result demonstrate that the principle of least action is wrong?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
      ...
      <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>17.</b></td>
              <td valign="top"><p><b><i>Minimum action for segments I?</i> HUNT for a worldline of minimum action. Now zoom in on one intermediate point and move it up and down. Pay attention to the values of the action in the table at the right. Does moving the point increase or decrease the value of the summed action on the two adjacent segments? Does it increase or decrease the value of the total action along the worldline?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>18.</b></td>
              <td valign="top"><p><b><i>Minimum action for segments II?</i>  RESET and construct a worldline that is <i>not</i> one of minimum action. One way to do this is to HUNT and then press PAUSE quickly, before the display reaches equilibrium. Zoom in on one intermediate point and <i>predict:</i> Can you move this point so that the summed action on the two adjacent segments increase or decrease? Try it. Was your prediction correct? In this case can you move the point so that the value of the total action along the worldline decreases?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>19.</b></td>
              <td valign="top"><p><b><i>Minimum action for segments III?</i>  Explain any difference between the results you found in questions 17 and 18. State clearly the answer to the following question: Under what circumstances can moving one intermediate point-event increase the total value of the action along the worldline?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>20.</b></td>
              <td valign="top"><p><b><i>Acceleration a minimum?</i> HUNT for a worldline of minimum action, then zoom in, click on one event without moving it, and record the acceleration on the segment pair (value given in the lower right). <i>Predict</i> what will happen when you drag that point up and down: Will the value of the acceleration increase or decrease? Is the acceleration between these two segments either a minimum or a maximum for the minimum-action worldline? Now drag the point up and then down. Was your prediction correct?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
        <table width="100%" border={0} cellSpacing={2} cellPadding={2}>
          <tbody><tr>
              <td width="10%" align="right" valign="top"><b>21.</b></td>
              <td valign="top"><p><b><i>Total energy a minimum?</i> HUNT for a worldline of minimum action, then zoom in, click on one event without moving it, and record the energies along each of the two segments on either side of that point. <i>Predict</i> what will happen when you drag that point up and down: Will the energies on the adjacent segments increase or decrease? For the minimum-action worldline, is the energy a minimum (or maximum)? Now drag the point up and then down. Was your prediction correct?<br /><br /></b></p></td>
            </tr>
          </tbody></table>
